...
- legga da tastiera una sequenza di numeri interi e, per ciascun valore inserito, aggiunga un nuovo nodo *in testa* alla lista; la lettura termina quando viene inserito un carattere;
